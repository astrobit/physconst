...
void Generate(const std::vector<GroupContainer > & i_vGroups)
{
	...
	fprintf(fileOut,"    [2020/01/22 v1.0 Physical constants package]\n");
	fprintf(fileOut,"%%</package>\n");
	...
	fprintf(fileOut,"%%\n");
	fprintf(fileOut,"%% \\changes{v1.0}{2020/01/23}{Initial version}\n");
	fprintf(fileOut,"%%\n");
	fprintf(fileOut,"%% \\GetFileInfo{physconst.dtx}\n");
	fprintf(fileOut,"%% \\def\\fileversion{v1.0}\n");
	fprintf(fileOut,"%% \\def\\filedate{2020/01/23}\n");
	fprintf(fileOut,"%%\n");
